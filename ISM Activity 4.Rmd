...
```
 Intro
```{r, include=FALSE}
pack <- c("tidyverse", "mosaic", "ggformula", 'car', 'AICcmodavg')
...
The weight of pumpkins has a skewed distribution to the left (positive skewness). The values are distributed around the mean = 805.26, with a standard deviation = 531.07.
