...
x(rnorm(100, mean = 120, sd= 100)
c(rnorm(100, mean = 52, sd= 2)
  
t1 <- c(1,2,3)
t2 <- c(3,2,1)

tt <- data.frame(t1<-(rnorm(100, mean = 50, sd=12)), t2<-(rnorm(100, mean = 25, sd= 13)))

  
sasa <- as.data.frame(x(1,2,3), t(1,2,3))
  
  
  xc <- as.data.frame(c(x<-(rnorm(100, mean = 120, sd= 100), c<-(rnorm(100, mean = 52, sd= 2))
