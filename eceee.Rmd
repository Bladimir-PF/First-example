...
We can use different commands to create data depending on the type of variable we need. For instance:

*`runif`: random rational numbers, e.g. `runif(100, min=0, max=1)`
...
/.;dddddd4dsddddd[;?;.;/
set.seed(1234)
income <- sample(250: 1500, 250, replace = T)

set.seed(1234)
SEG <- sample(250: 1, 250, replace = T)
